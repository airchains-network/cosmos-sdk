...
import (
	...
	v1auth "github.com/airchains-network/cosmos-sdk/x/auth/migrations/v1"
	authtypes "github.com/airchains-network/cosmos-sdk/x/auth/types"
	bankv4 "github.com/airchains-network/cosmos-sdk/x/bank/migrations/v4"
	banktypes "github.com/airchains-network/cosmos-sdk/x/bank/types"
	v1distr "github.com/airchains-network/cosmos-sdk/x/distribution/migrations/v1"
	v3distr "github.com/airchains-network/cosmos-sdk/x/distribution/migrations/v3"
	...
	v4gov "github.com/airchains-network/cosmos-sdk/x/gov/migrations/v4"
	govv1 "github.com/airchains-network/cosmos-sdk/x/gov/types/v1"
	groupv2 "github.com/airchains-network/cosmos-sdk/x/group/migrations/v2"
)
