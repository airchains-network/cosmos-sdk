...
import (
	...
	types1 "github.com/airchains-network/cosmos-sdk/crypto/types"
	github_com_cosmos_cosmos_sdk_types "github.com/airchains-network/cosmos-sdk/types"
	types2 "github.com/airchains-network/cosmos-sdk/types"
	_ "github.com/airchains-network/cosmos-sdk/types/tx/amino"
	signing "github.com/airchains-network/cosmos-sdk/types/tx/signing"
...
type TxBody struct {
	...
	// but should be called `note` instead (see https://github.com/airchains-network/cosmos-sdk/issues/9122).
...
type Fee struct {
	...
	Amount github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,1,rep,name=amount,proto3,castrepeated=github.com/airchains-network/cosmos-sdk/types.Coins" json:"amount"`
