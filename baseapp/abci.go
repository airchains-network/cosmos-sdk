...
func (app *BaseApp) Query(_ context.Context, req *abci.RequestQuery) (resp *abci.ResponseQuery, err error) {
	...
	//
	// Ref: https://github.com/airchains-network/cosmos-sdk/pull/8039
	defer func() {
		if r := recover(); r != nil {
...
//
// Ref: https://github.com/airchains-network/cosmos-sdk/blob/main/docs/architecture/adr-060-abci-1.0.md
